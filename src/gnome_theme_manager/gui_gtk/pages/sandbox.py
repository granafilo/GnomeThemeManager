"""Controller per la pagina 'Strumenti sandbox' (Fase 5.2.1).

Questo modulo gestisce il caricamento dichiarativo della vista dedicata
alla diagnostica, stato e propagazione dei permessi sandbox per Snap e Flatpak.
"""
